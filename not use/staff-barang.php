...
<body>
                    ...
                    <table style="background-color: white;" class="table-tab">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> <?= $result['stok'] ?></td>
                                <td>
                                    <a class="btn btn-warning" href="function/edit_barang.php?ID_Barang=<?=$result['ID_Barang'];?>"><i class="bi bi-pencil"></i></a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus ?')" href="function/hapus_barang.php?ID_Barang=<?=$result['ID_Barang'];?>"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="function/add-barang.php">
                <div style="color: white;" class="row">
                    <div class="form-group col-md-6">
                        <label style="margin-bottom: 5px;" for="tambahid">ID Barang</label>
                        <input type="text" class="form-control" id="IDBarang" placeholder=""> <br>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="KategoriBarang" placeholder=""> <br>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="HargaBeli" placeholder="">
                    </div>
                    <div class="form-group col-md-6">
